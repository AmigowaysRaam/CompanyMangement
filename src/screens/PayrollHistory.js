...
import { getPayRollHistory } from '../redux/authActions';
...
const PayrollHistory = () => {
        ...
        return (
            ...
            >
                ...
                <Text style={[
                    ...
                    {`Rs.${Number(category?.salary).toFixed(2)}`}
                </Text>
                <Text style={[
                    Louis_George_Cafe.regular.h9,
                    styles.categoryTitle,
                    {
                        fontSize: isTamil ? wp(2.5) : wp(3),
                        color: category?.paidStatus == 'Paid' ? "green" : "red",
                        fontWeight: "600"
                    }
                ]}>
                    {category?.paidStatus}
    ...
    return (
        <>
            <HeaderComponent title={t('payrollHistory')} showBackArray={true} />
            <View style={[styles.container, { backgroundColor: THEMECOLORS[themeMode].background }]}>
                ...
                }
                {
                    ...
                    <View style={{
                        backgroundColor: "#EDF2FF", justifyContent: "center", borderRadius: wp(2), paddingTopTop: wp(2),
                    }}>
                        <View
