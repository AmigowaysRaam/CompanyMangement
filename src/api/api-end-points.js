...
// API_GET_DEPARTMENTLIST_CONTENT_URL
const API_GET_DEPARTMENTLIST_CONTENT_URL = {
  url: `${API_BASE_URL}mob-department-list`,
  method: "POST",
  responseDataKey: "data",
};
// API_CREATE_DEPARTMENT_URL
const API_CREATE_DEPARTMENT_URL = {
  url: `${API_BASE_URL}mob-department-create`,
  method: "POST",
  responseDataKey: "data",
};

// API_UPDATE_DEPARTMENT_URL
const API_UPDATE_DEPARTMENT_URL = {
  url: `${API_BASE_URL}mob-department-update`,
  method: "POST",
  responseDataKey: "data",
};


// API_DELETE_DEPARTMENT_URL

const API_DELETE_DEPARTMENT_URL = {
  url: `${API_BASE_URL}mob-department-delete`,
  method: "POST",
  responseDataKey: "data",
};

// 
const API_GET_REQUESTED_LEAVE_ARRAY_URL = {
  url: `${API_BASE_URL}mob-getemployeeleave-request`,
  method: "POST",
  responseDataKey: "data",
};

// API_UPDATE_LEAVE_ARRAY_URL
const API_UPDATE_LEAVE_ARRAY_URL = {
  url: `${API_BASE_URL}mob-update-leave-status`,
  method: "POST",
  responseDataKey: "data",
};
// API_GET_BRANHC_BY_COMPANY_SUBMIT_URL

const API_GET_BRANHC_BY_COMPANY_SUBMIT_URL = {
  url: `${API_BASE_URL}mob-company-branch-list`,
  method: "POST",
  responseDataKey: "data",
};

// API_GET_HOLIDAY_ARRAY_URL

const API_GET_HOLIDAY_ARRAY_URL = {
  url: `${API_BASE_URL}mob-getholidays`,
  method: "POST",
  responseDataKey: "data",
};

// API_GET_EMPLOYEE_STEP_DATA_URL
const API_GET_EMPLOYEE_STEP_DATA_URL = {
  url: `${API_BASE_URL}mob-employee-tabs`,
  method: "POST",
  responseDataKey: "data",
};

const API_GET_CREATE_EMP_URL = {
  url: `${API_BASE_URL}mob-register-employee`,
  method: "POST",
  responseDataKey: "data",
};

// API_GET_EMP_DATA_BY_ID_URL
const API_GET_EMP_DATA_BY_ID_URL = {
  url: `${API_BASE_URL}mob-get-employeebyid`,
  method: "POST",
  responseDataKey: "data",
};
...
// API_EMPL_LIST_URL
const API_EMPL_LIST_URL = {
  url: `${API_BASE_URL}mob-department-category-list`,
  method: "POST",
  responseDataKey: "data",
};

// API_CREATE_EMP_POSTION_URL
const API_CREATE_EMP_POSTION_URL = {
  url: `${API_BASE_URL}mob-department-category-create`,
  method: "POST",
  responseDataKey: "data",
};

// API_UPDATE_EMP_POSTION_URL
const API_UPDATE_EMP_POSTION_URL = {
  url: `${API_BASE_URL}mob-department-category-update`,
  method: "POST",
  responseDataKey: "data",
};

// API_DELETE_EMP_POSTION_URL
const API_DELETE_EMP_POSTION_URL = {
  url: `${API_BASE_URL}mob-department-category-delete`,
  method: "POST",
  responseDataKey: "data",
};
// API_CREATE_HOLIDAY_URL
const API_CREATE_HOLIDAY_URL = {
  url: `${API_BASE_URL}mob-holiday-create`,
  method: "POST",
  responseDataKey: "data",
};

// API_UPDATE_HOLIDAY_URL
const API_UPDATE_HOLIDAY_URL = {
  url: `${API_BASE_URL}mob-holiday-update`,
  method: "POST",
  responseDataKey: "data",
};


// API_DELETE_HOLIDAY_URL
const API_DELETE_HOLIDAY_URL = {
  url: `${API_BASE_URL}mob-holiday-delete`,
  method: "POST",
  responseDataKey: "data",
};


// API_GET_SALARYSTUCTURELIST_CONTENT_URL
const API_GET_SALARYSTUCTURELIST_CONTENT_URL = {
  url: `${API_BASE_URL}mob-salary-list`,
  method: "POST",
  responseDataKey: "data",
};

// API_GET_SALARYSTRUCTR_TAB_URL
const API_GET_SALARYSTRUCTR_TAB_URL = {
  url: `${API_BASE_URL}mob-salarystructure-tabs`,
  method: "POST",
  responseDataKey: "data",
};

// API_SALARYSTIURCTURE_BY_ID_CONTENT_URL
const API_SALARYSTIURCTURE_BY_ID_CONTENT_URL = {
  url: `${API_BASE_URL}mob-getsalary-byid`,
  method: "POST",
  responseDataKey: "data",
};

// API_SUBMIT_CREATE_SALARY_COMPANY
const API_SUBMIT_CREATE_SALARY_COMPANY = {
  url: `${API_BASE_URL}mob-create-salarystructure`,
  method: "POST",
  responseDataKey: "data",
};
// API_UPFDATE_SALARY_COMPANY
const API_UPFDATE_SALARY_COMPANY = {
  url: `${API_BASE_URL}mob-update-salarystructure`,
  method: "POST",
  responseDataKey: "data",
};

// API_GET_ADMIN_ARRAY_URL
const API_GET_ADMIN_ARRAY_URL = {
  url: `${API_BASE_URL}mob-getall-superadmins`,
  method: "POST",
  responseDataKey: "data",
};

// API_CREATE_ADMIN_URL

const API_CREATE_ADMIN_URL = {
  url: `${API_BASE_URL}super-admins`,
  method: "POST",
  responseDataKey: "data",
};


// API_GET_ADMIN_BY_ID_DATA_URL
const API_GET_ADMIN_BY_ID_DATA_URL = {
  url: `${API_BASE_URL}mob-get-superadmins-byid`,
  method: "POST",
  responseDataKey: "data",
};

const API_UPDATE_ADMIN_URL = {
  url: `${API_BASE_URL}super-admins-update`,
  method: "POST",
  responseDataKey: "data",
};
// API_GET_GENARTRE_PAYROLL_URL
const API_GET_GENARTRE_PAYROLL_URL = {
  url: `${API_BASE_URL}generate-payroll/bulk`,
  method: "POST",
  responseDataKey: "data",
};
// API_DELETE_ADMIN__URL
const API_DELETE_ADMIN__URL = {
  url: `${API_BASE_URL}mob-delete-superadmin`,
  method: "POST",
  responseDataKey: "data",
};
// 
const API_GET_SHIFTS_BY_COMPANY_SUBMIT_URL = {
  url: `${API_BASE_URL}get-company-shifts`,
  method: "POST",
  responseDataKey: "data",
};
// API_GET_PROJECT_STATS_BY_ID_CONTENT_URL

const API_GET_PROJECT_STATS_BY_ID_CONTENT_URL = {
  url: `${API_BASE_URL}mob-project-with-tasks`,
  method: "POST",
  responseDataKey: "data",
};
// 
const API_SHIFTS_LISTING_URL = {
  url: `${API_BASE_URL}mob-shifts`,
  method: "POST",
  responseDataKey: "data",
};
...
export default {
  APP_GENERATE_TOKEN,API_SHIFTS_LISTING_URL,API_GET_PROJECT_STATS_BY_ID_CONTENT_URL, API_UPDATE_ADMIN_URL, API_GET_SHIFTS_BY_COMPANY_SUBMIT_URL, API_GET_GENARTRE_PAYROLL_URL, API_UPDATE_HOLIDAY_URL, API_GET_ADMIN_BY_ID_DATA_URL, API_SALARYSTIURCTURE_BY_ID_CONTENT_URL, API_GET_PROJECT_STEP_DATA_URL, API_GET_HOLIDAY_ARRAY_URL, API_SUBMIT_ROLES_ACCESS_DATA_URL,
  API_UPDATE_PROJECT_USER_URL, API_GET_ASSIGNED_TASK_USER_URL, API_UPDATE_ROLES_ACCESS_DATA_URL,
  API_GET_TASK_BY_ID_URL, API_DELETE_EMP_POSTION_URL, API_UPDATE_TASK_URL, API_TASK_STATUS_TASK_USER_URL, API_CREATE_DEPARTMENT_URL,
  API_GET_TASK_LIST_DATA_URL, API_GET_GROUPCHAT_DETAILS_URL, API_USER_SOCIAL_MEDIA_URL, API_GET_EMPLOYEE_STEP_DATA_URL,
  API_PROJECT_DOCUMENT_UPLOAD_DTA, API_GET_PROJECT_DOCS_URL, API_GET_MODULE_LIST_BY_ID_DATA_URL,
  API_FORM_SUBMIT_BY_ID_URL, API_SEND_MESSAGES_LIST_URL, API_DELETE_MODULE_ACCESS_URL, API_DELETE_HOLIDAY_URL,
  API_SITE_URL, API_LANGUAGE_URL, API_LOGIN_URL, API_LANGUAGE_CONTENT_URL, API_UPDATE_DEPARTMENT_URL,
  API_GET_CATEGORY_LIST, API_GET_SUB_CATEGORY_LIST, GET_SIDE_MENU_API, USER_UPDATE_PRO_PIC, API_CREATE_ADMIN_URL,
  GET_PROFILE_MENU_API, API_MOBILE_CHECK, API_GET_SETTINGS_MENU_URL, API_GET_DEPARTMENTLIST_CONTENT_URL,
  ...
  API_RESETMPIN_URL, API_CHANGE_NOTIFICATION_URL, API_DELETE_ADMIN__URL, API_CHANGE_PASSCODE_URL, API_GET_PAYROLL_LIST,
  ...
  API_CREATE_EMPLOYEE_URL, API_CREATE_PUNCH_IN_OUT_URL, API_GET_PUNCH_IN_OUT_HISTORY_URL, API_GET_ADMIN_ARRAY_URL,
  API_LEAVE_FORM_SUBMIT_URL, API_GET_LEAVE_ARRAY_URL, API_GET_BRANHC_BY_COMPANY_SUBMIT_URL,
  API_APP_PUNCHED_URL, API_GET_LOGIN_HISTOY_LIST, API_GET_REQUESTED_LEAVE_ARRAY_URL, API_CREATE_HOLIDAY_URL,
  API_GENERATE_PAYROLL_URL, API_GET_CHAT_LIST_URL, API_GET_SUB_CATEGORY_LIST_ARR, API_UPDATE_EMP_URL,
  API_FILES_DATA_URL, API_GET_COMPANYLIST_CONTENT_URL, API_GET_COMPANY_DATA_URL, API_GET_EMP_DATA_BY_ID_URL,
  API_UPLOAD_DTA, APIGET_CATEGORY_URL, API_CRETE_CATYEGORY_URL, API_UPDATE_CATYEGORY_URL,
  API_SUBMIT_COMPANY, API_GET_CLIENT_STEP_DATA_URL, API_DELETE_DEPARTMENT_URL, API_UPFDATE_SALARY_COMPANY,
  API_UPDATE_CONTACT_SUBMIT_COMPANY, API_GET_COMPANY_DATA_BY_ID_URL, API_EMPL_LIST_URL,
  API_CREATE_CLIENT_COMPANY, API_GET_MODULE_LIST_DATA_URL, API_GET_CREATE_EMP_URL,
  API_UPDATE_CLIENT__DATA_URL, API_GET_MODULE_LIST_ARRAY_DATA_URL, API_SUBMIT_CREATE_SALARY_COMPANY,
  API_GET_CLIENT_DATA_BY_ID_URL, API_PROJECT_REMOVE_USER_URL, API_GET_SALARYSTUCTURELIST_CONTENT_URL,
  API_CREATE_PROJECT_URL, API_GET_PROJECT_DETAIL_BY_ID_URL,
  API_UPDATE_CREATE_PROJECT_URL, API_UPDATE_EMP_POSTION_URL, API_GET_SALARYSTRUCTR_TAB_URL,
  API_PROJECT_DELETE_URL, API_CREATE_EMP_POSTION_URL,
  API_GET_CHAT_MESSAGES_LIST_URL, API_UPDATE_PROJECT_DETAILS_URL,
  API_CREATE_TASK_URL, API_BTTOM_NAVIGATION_URL, API_UPDATE_LEAVE_ARRAY_URL
};
